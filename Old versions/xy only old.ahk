/*
	By		: rafaell0 (based on NotNull & DaWolfi)
...
;_____________________________________________________________________________
{
  ...
  global $OpenMenu, $GuiColor, $MenuColor, $ReDisplayMenu, $FolderNum
  global $LastMenuItem := ""
  global $FromSettings := FALSE
  ...
  Loop, %_allWindows%
  {
    ...
    If (_thisClass = "ThunderRT6FormDC") ; XYPlorer
    {
	  ...
	  {
		  Menu ContextMenu, Add, %A_LoopField%, FolderChoice
	  }
...
Setting_Controls:
;_____________________________________________________________________________
  global $OpenMenu, $GuiColor, $MenuColor, $WinX, $WinY, $WinWidth, $WinHeight, $LastMenuItem, $FromSettings, $FolderNum
