...
ShortPath()
{
  ; The ShortPath checkbox hides or displays additional options.
  global
  
  Gui, Submit, NoHide  ; current checkbox state
  If (ShortPath) 
  {
	GuiControl, , ShortPath, Show short path, indicate as:
	GuiControl, Show, CutFromEnd
	GuiControl, Show, ShowDriveLetter
	GuiControl, Show, FoldersCount
	GuiControl, Show, FoldersCountText
	GuiControl, Show, FolderNameLength
	GuiControl, Show, FolderNameLengthText
	GuiControl, Show, PathSeparator
	GuiControl, Show, PathSeparatorText
	GuiControl, Show, ShortNameIndicator
	GuiControl, Show, ShortNameIndicatorText
  } 
  Else 
  {
	GuiControl, , ShortPath, Show short path
	GuiControl, Hide, CutFromEnd
	GuiControl, Hide, ShowDriveLetter
	GuiControl, Hide, FoldersCount
	GuiControl, Hide, FoldersCountText
	GuiControl, Hide, FolderNameLength
	GuiControl, Hide, FolderNameLengthText
	GuiControl, Hide, PathSeparator
	GuiControl, Hide, PathSeparatorText
	GuiControl, Hide, ShortNameIndicator
	GuiControl, Hide, ShortNameIndicatorText
...
;_____________________________________________________________________________
{
  ...
  */ 
  ...
  ; MENU SETTINS		
  Gui, 	Add, 	CheckBox, 	x30 y+20 		vOpenMenu  		checked%OpenMenu%, 			&Always open Menu if AutoSwitch disabled
  ...
  local Xpos := WinX
  local Ypos := WinY + 100 
  Gui, Show, x%Xpos% y%Ypos% w320 h390, QuickSwitch Settings
