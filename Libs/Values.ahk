...
{  
  ...
  Else
    TrayTip, QuickSwitch error, You did not enter an integer for the %_iniParamName% parameter,, 0x2 
}
...
;_____________________________________________________________________________
{
  ...
  Else 
  {
	TrayTip, QuickSwitch error, You have chosen the wrong color for %_iniParamName%! Enter the HEX value,, 0x2 
  }
}
