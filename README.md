This is an improved version of the `QuickSwitch script v0.5` from Gepruts. It was first improved by DaWolfi. And I have released the next version 1.0, in which I have made significant improvements!
